...
class ViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    @objc func timerFired() {
        ...
        timeLable.text = String(format: NSLocalizedString("Time Remaining: %.2f", comment: ""), seconds)
    ...
    func checkForGameEnd() {
        ...
        if hasWon == true {
            ...
            showAlert(title: NSLocalizedString("Congratulations!", comment: ""), message: NSLocalizedString("You've won the game!", comment: ""))
            ...
            if milliseconds <= 0 {
                showAlert(title: NSLocalizedString("Time's Up", comment: ""), message: NSLocalizedString("Sorry, better luck next time!", comment: ""))
    ...
    func showAlert(title:String, message:String) {
        ...
        let rplayAction = UIAlertAction(title: NSLocalizedString("Replay", comment: ""), style: .default) { action in
            let storyboard = UIStoryboard(name: "Main", bundle: nil)
            let myVC = storyboard.instantiateViewController(withIdentifier: "VCGamePlay")
            self.present(myVC, animated: false, completion: nil)
        }
        alert.addAction(rplayAction)
